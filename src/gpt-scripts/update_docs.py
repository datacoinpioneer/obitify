...
repo_owner = "datacoinpioneer"  # Replace with your GitHub username or organization
repo_name = "obitify"  # Replace with your GitHub repository name
token = os.getenv('GITHUB_TOKEN')  # GitHub token (from the workflow environment variable)
...
headers = {
    'Authorization': f'token {token}',  # Use the token passed by GitHub Actions
    'Content-Type': 'application/json'
}

# The content for the markdown file (this would be generated by your AI or logic)
new_content = """
...
# Attempt to fetch the current file details to check if the file exists
...
if response.status_code == 200:
    ...
    create_data = {
        "message": "Automated creation of requirements document",
        "content": base64_content  # New content to be added to the file
    }
